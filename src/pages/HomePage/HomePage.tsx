...
const NAV_CARDS: NavCard[] = [
  {
    ...
    description:
      "Ведите активные заявки, переписывайтесь с абитуриентами в реальном времени и фиксируйте решения.",
    color: "teal",
  },
  {
    href: "/queue",
    ...
    description:
      "Смотрите все входящие обращения, распределяйте нагрузку и контролируйте статус заявок.",
    color: "blue",
    adminOnly: true,
  },
  {
